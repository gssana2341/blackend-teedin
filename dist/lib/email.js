...
exports.testEmailConnection = exports.sendOTPEmail = void 0;
...
const sendOTPEmail = async (to, otpCode, config) => {
...
const testEmailConnection = async () => {
    try {
        ...
        if (etherealConfig) {
            const transporter = nodemailer_1.default.createTransport(etherealConfig);
            await transporter.verify();
            return {
                success: true,
                provider: "ethereal",
